  ...
  _crearProducto(BuildContext context){
    if(widget.usuario.rol == "provider"){
      return FloatingActionButton(
        ...
        onPressed: () => Navigator.pushNamed(context, 'producto',arguments: widget.usuario),
      );
    }else{
      return null;
    }     
            ...
            return ListView.builder(
               shrinkWrap: true,
                ...
                itemBuilder: (_,int index){
                  ...
                  Producto _producto = Producto.fromSnapshot(snapshot.data.documents[index]);               
            ...
            child: Column(
              children: <Widget> [
                  ListTile(
                    ...
                    trailing: new Text("Precio "+producto.data.precio.toString()),
                  )
              ]
            ),
          );
